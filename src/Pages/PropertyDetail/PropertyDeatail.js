                ...
                <div className="title-row">
                  ...
                  <div className="price-box">
                    <div className="Rent-container">
                      <h3 className="price">
                        $3500/<span className="price-type">Rent</span>
                      </h3>
              ...
              <div>
                <section className="about-property">
                  ...
                  <ul className="detail-list">
                    ...
                    <li>
                      Credibly reintermediate backend data for cross-platform
                      models
                    </li>
                  </ul>
                  ...
                  <p>
                    ...
                    more-or-less normal distribution of letters, as felt opposed
                    to using &apos;Content here making it look like readable.
                  </p>
                </section>
                ...
                <section className="nearby">
                  ...
                  <p>
                    la consequat massa quis enim. Donec pede justo, fringilla
                  ...
                  <div className="nearby-grid">
                    <div className="near-item">
                      <strong>School:</strong> 0.5km
                    </div>
                    <div className="near-item">
                      <strong>Hospital,medical:</strong> 1.3km
                    </div>
                    <div className="near-item">
                      <strong>Metro station:</strong> 0.1km
                    </div>
                    <div className="near-item">
                      <strong>University:</strong> 2.2km
                    </div>
                    <div className="near-item">
                      <strong>Grocery Center:</strong> 0.2km
                    </div>
                    <div className="near-item">
                      <strong>River:</strong> 0.6km
                    </div>
                    <div className="near-item">
                      <strong>Gym,wellness:</strong> 1.4km
                    </div>
                    <div className="near-item">
                      <strong>River:</strong> 0.6km
                    </div>
                    ...
                    <div className="comment-item mb-4 p-3 border rounded">
                      <div className="row g-3 align-items-start">
                        ...
                        <div className="col-md-10 ">
                          ...
                          <p className="mb-3">
                            Mi quis hendrerit dolor magna eget est lorem. Velit
                            sed ullamcorper morbi tincidunt ornare massa.
                            Tristique senectus et netus et. Iaculis eu non diam.
                          </p>
                      ...
                      <div className="row g-3 align-items-start">
                        ...
                        <div className="col-md-10 ">
                          ...
                          <p className="mb-3">
                            ...
                            sed ullamcorper morbi tincidunt ornare massa.
                            Tristique senectus et netus et. Iaculis eu non diam
                            phasellus. Nullam ac tortor vitae purus. Eget nullam
                            non nisi est sit amet faci.
                          </p>
                  ...
                  <section>
                    ...
                    <div className="form-group">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setReview({ ...review, website: e.target.value })
                        }
                        type="text"
                        placeholder="Website"
                      />
                ...
                <aside className="side-col">
                  ...
                  <div className="agent-card">
                    ...
                    <p className="agent-bio">
                      A perfect property finder and seller with great knowledge
                      in the real estate field. Talented in searching for a
                      property within the customer's needed areas.
                    </p>
                    <div className="agent-contact">
                      <div className="d-flex align-items-center justify-content-center px-4 gap-4">
                        ...
                        />
                        <a href="mailto:anne.hathaway@email.com">
                          anne.hathaway@email.com
                        </a>
                      </div>
                      <div className="d-flex align-items-center justify-content-center px-4 gap-4">
                        <img
